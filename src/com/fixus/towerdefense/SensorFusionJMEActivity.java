...
public class SensorFusionJMEActivity extends AndroidHarness  {
    ...
    class calculateFusedOrientationTask extends TimerTask {
        public void run() {
			...
			if ((com.fixus.towerdefense.tools.SensorFusionJME) app != null) {
				((com.fixus.towerdefense.tools.SensorFusionJME) app).setRotationFused((float)(fusedOrientation[2]), (float)(-fusedOrientation[0]), (float)(fusedOrientation[1]));
			}
        }
    }
...
//			Log.d(TAG, "onSensorChanged: " + event.toString());
	...
	private final Camera.PreviewCallback mCameraCallback = new Camera.PreviewCallback() {
		public void onPreviewFrame(byte[] data, Camera c) {
			if (c != null && stopPreview == false) {
				...
				if ((com.fixus.towerdefense.tools.SensorFusionJME) app != null) {
					((com.fixus.towerdefense.tools.SensorFusionJME) app)
	...
	public SensorFusionJMEActivity() {
		...
		appClass = "com.fixus.towerdefense.tools.SensorFusionJME";
